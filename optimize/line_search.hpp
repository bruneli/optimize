...
double get_pol3_minimum(double a, double fa, double dfa, double b, double fb,
                        double c, double fc);

//! Find the minimum between 2 points via a second order polynom
double get_pol2_minimum(double a, double fa, double dfa, double b, double fb);
